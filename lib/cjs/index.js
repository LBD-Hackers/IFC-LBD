...
var LBDParser = /*#__PURE__*/function () {
  ...
  _createClass(LBDParser, [{
    ...
    value: function () {
      var _parsePropertyTriples = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(ifcApi, modelID) {
        var verbose,
            productParser,
            _args3 = arguments;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                productParser = new _propertyParser.PropertyParser(ifcApi, modelID, this.format, verbose);
                _context3.next = 4;
                return productParser.doParse();
    ...
    key: "parseFSOTriples",
    value: function () {
      var _parseFSOTriples = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(ifcApi, modelID) {
        var verbose,
            fsoParser,
            _args4 = arguments;
    ...
    key: "parseTSOTriples",
    value: function () {
      var _parseTSOTriples = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(ifcApi, modelID) {
        var verbose,
            tsoParser,
            _args5 = arguments;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                tsoParser = new _tsoParser.TSOParser(ifcApi, modelID, this.format, verbose);
                _context5.next = 4;
