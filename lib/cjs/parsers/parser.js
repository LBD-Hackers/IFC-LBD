...
var _bundle = require("comunica-geosparql/lib/bundles/bundle.umd");
...
var Parser = /*#__PURE__*/function () {
  function Parser(ifcAPI, modelID) {
    ...
    _defineProperty(this, "extensionFunctions", _objectSpread(_objectSpread({}, _communicaExtensionFunctions.extensionFunctions), _bundle.geoSPARQLFunctions));
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                // Initiate the update
                engine = (0, _actorInitSparqlRdfjs.newEngine)();
                _context4.next = 3;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.next = 3;
                return this.serializeStoreContent(_BaseDefinitions.N3Format.NQuads);
