...
var FSOParser = /*#__PURE__*/function (_Parser) {
  ...
  _createClass(FSOParser, [{
    ...
    key: "segmentLengths",
    value: function () {
      var _segmentLengths = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
        var query;
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                query = "PREFIX geosf: <http://www.opengis.net/def/function/geosparql/>\n        SELECT *\n        WHERE{\n            BIND(\"POINT Z(0 0 0)\" AS ?p1)\n            BIND(\"POINT Z(0 1 1)\" AS ?p2)\n            BIND(geosf:distance(?p1, ?p1) AS ?d)\n        }";
                _context9.next = 3;
    ...
    key: "getPortIDs",
    value: function () {
      var _getPortIDs = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
