          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.next = 5;
                return (0, _pathSearch.buildRelOneToOne)(this.ifcAPI, this.modelID, _webIfc.IFCRELSPACEBOUNDARY, subjectRef, targetRef, rdfRelationship, true);
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                subjectClass = _webIfc.IFCSPACE;
                _context8.next = 6;
                return (0, _pathSearch.buildRelOneToMany)(this.ifcAPI, this.modelID, _webIfc.IFCRELCONTAINEDINSPATIALSTRUCTURE, subjectRef, targetRef, rdfRelationship, subjectClass);
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                subjectClass = _webIfc.IFCBUILDINGSTOREY;
                _context9.next = 6;
                return (0, _pathSearch.buildRelOneToMany)(this.ifcAPI, this.modelID, _webIfc.IFCRELCONTAINEDINSPATIALSTRUCTURE, subjectRef, targetRef, rdfRelationship, subjectClass);
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                _context10.next = 5;
                return (0, _pathSearch.buildRelOneToOne)(this.ifcAPI, this.modelID, _webIfc.IFCRELVOIDSELEMENT, subjectRef, targetRef, rdfRelationship);
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                subjectClass = _webIfc.IFCBUILDINGSTOREY;
                targetClass = _webIfc.IFCSPACE;
                _context11.next = 7;
                return (0, _pathSearch.buildRelOneToMany)(this.ifcAPI, this.modelID, _webIfc.IFCRELAGGREGATES, subjectRef, targetRef, rdfRelationship, subjectClass, targetClass);
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                subjectClass = _webIfc.IFCBUILDING;
                targetClass = _webIfc.IFCBUILDINGSTOREY;
                _context12.next = 7;
                return (0, _pathSearch.buildRelOneToMany)(this.ifcAPI, this.modelID, _webIfc.IFCRELAGGREGATES, subjectRef, targetRef, rdfRelationship, subjectClass, targetClass);
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                subjectClass = _webIfc.IFCSITE;
                targetClass = _webIfc.IFCBUILDING;
                _context13.next = 7;
                return (0, _pathSearch.buildRelOneToMany)(this.ifcAPI, this.modelID, _webIfc.IFCRELAGGREGATES, subjectRef, targetRef, rdfRelationship, subjectClass, targetClass);
